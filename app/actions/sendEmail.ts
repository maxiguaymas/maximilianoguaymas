          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background-color: #f3f4f6; padding: 20px 30px; text-align: center;">
              <p style="font-size: 12px; color: #9ca3af; margin: 0;">
                Este es un mensaje automático enviado desde <a href="https://maximilianoguaymas.vercel.app/" style="color: #6b7280; text-decoration: underline;">maximilianoguaymas.vercel.app</a>
              </p>
